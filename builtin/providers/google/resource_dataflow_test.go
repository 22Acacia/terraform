...
resource "google_dataflow" "foobar" {
	name = "foobar"
	jarfile = "google-cloud-dataflow-java-examples-all-bundled-1.1.1-SNAPSHOT.jar?
	class = "com.google.cloud.dataflow.examples.MinimalWordCount"
	staging_bucket = "foobar"
}
`, randInt)
